...
class Guest extends Component{
    ...
    renderItem(){
      ...
      handle(number){
        // let url = "https://localhost:5001/api/v1/Guests?pagenumber=" + this.state.pagenumber + 
        // "&rowsofpage=" + this.state.rowsofpage + "&search=" + this.state.search;
        // this.componentDidMount(url);
