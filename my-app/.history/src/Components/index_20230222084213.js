          ...
          <ul className="sidebar-nav" id="sidebar-nav">
            ...
            <li className="nav-item">
              ...
              <ul id="forms-nav" className="nav-content collapse " data-bs-parent="#sidebar-nav">
                <li>
                  <a className="nav-link collapsed" data-bs-target="#components-nav" data-bs-toggle="collapse" href="#" onClick={(e) => {this.setState({option: "thuê phòng"});
                this.selectOptionsEvent(e.target);}}>
                    <i className="bi bi-circle" /><span>Thuê Phòng</span>
                  </a>
                </li>
                <li>
                  <a className="nav-link collapsed" data-bs-target="#components-nav" data-bs-toggle="collapse" href="#" onClick={(e) => {this.setState({option: "gọi dịch vụ"});
                this.selectOptionsEvent(e.target);}}>
