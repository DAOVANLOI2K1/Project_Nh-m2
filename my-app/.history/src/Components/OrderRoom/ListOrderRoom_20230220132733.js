    ...
    postData(url){
        ...
        .then((response) => {
            if(response){
                ...
                this.getData("https://localhost:5001/api/v1/OrderRooms?PageIndex=1&RowPerPage=500");
        ...
        .catch(err => {
            alert("Có lỗi trong quá trình đặt!");
            console.log(err)
        });
    }
    handleInsert(){
                ...
                <div className="card-body">
                    ...
                    <form>
                        ...
                        <div className="row mb-3">
                            ...
                            <div className="col-sm-10">
                                <input
                                    ...
                                    onChange={(e) =>
                                        this.handleFormThoiGianBDChange(e.target.value)
                                    }
                                />
                            </div>
                        </div>
                        ...
                        <div className="row mb-3">
                            ...
                            <div className="col-sm-10">
                                <input
                                    ...
                                    // value={this.props.ThoiGianGoi}
                                    onChange={(e) =>
                                        this.handleFormThoiGianKTChange(e.target.value)
                                    }
                                />
                            </div>
                        </div>
                        <div className="text-center">
                            ...
                            <div className="form_closeicon flex_center" onClick={() => this.setState({showFormCra: false})}>
