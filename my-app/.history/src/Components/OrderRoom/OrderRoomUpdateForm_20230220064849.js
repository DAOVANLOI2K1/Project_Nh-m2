    ...
    render(){
        ...
        return(
            ...
            <form>
                ...
                <div className="row mb-3">
                <div className="col-sm-10">
                    <button type="button" className="btn btn-warning" onClick={() => this.validateOrderRoomForm()}>
                        Sửa
                    </button>
                    <button type="button" className="btn btn-success"onClick={() =>this.props.OrderRoomUpdateCloseForm()}>Quay lại</button>
                </div>
                </div>
            </form>
            </div>
