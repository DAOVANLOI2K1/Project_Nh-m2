            ...
            <div className="card">
                <div className="card-body">
                    ...
                    <form>
                        ...
                        <div className="row mb-3">
                            <label htmlFor="ThoiGianGoi" className="col-sm-2 col-form-label">Thời gian bắt đầu thuê</label>
                            <div className="col-sm-10">
                                <input
                                    type="date"
                                    className="form-control"
                        ...
                        <div className="row mb-3">
                            <label htmlFor="ThoiGianGoi" className="col-sm-2 col-form-label">Thời gian trả phòng</label>
                            <div className="col-sm-10">
                                <input
                                    type="date"
                                    className="form-control"
