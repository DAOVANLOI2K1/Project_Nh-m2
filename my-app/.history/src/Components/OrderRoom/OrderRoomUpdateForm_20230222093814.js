...
class OrderRoomUpdatetForm extends Component{
    ...
    validateOrderRoomForm = () => {
        ...
        if (ngayDi === "") {
            ...
            errorOfNgayDi = errorOfNgayDi + "Ngày đi ph!\n";
        }
            ...
            <form>
                {/* <div className="row mb-3">
                    ...
                    <div className="col-sm-10">
                        ...
                        value={this.props.iddp}
                        onChange={(event) =>this.props.handleFormiddpChange(event.target.value)}
                        disabled/>
                    </div>
                </div> */}
                <div className="row mb-3">
                ...
                <div className="row mb-3">
                    ...
                    <div className="col-sm-10">
                        ...
                        />
                        <label style={errorMs} id="errorOfGia"></label>
                    </div>
                </div>
                <div className="row mb-3">
                ...
                <div className="row mb-3">
                <div className="col-sm-10">
                    <button type="button" className="btn btn-primary" onClick={() => this.validateOrderRoomForm()}>
                        Lưu
                    </button>
                    <button type="button" className="btn btn-info"onClick={() =>this.props.OrderRoomUpdateCloseForm()}>Trở về danh sách</button>
                </div>
                </div>
            </form>
            </div>
