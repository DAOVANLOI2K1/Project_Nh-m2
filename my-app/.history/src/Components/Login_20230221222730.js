...
class Login extends Component{
    ...
    validateLogin(username, password){
        ...
        if (errorOfUsername || errorOfPass) {
            ...
            document.getElementById("errorOfUsername").innerHTML = typeof errorOfUsername === "undefined" ? "" : errorOfCMT;
            document.getElementById("errorOfPass").innerHTML = typeof errorOfTenPhong === "undefined" ? "" : errorOfTenPhong;
