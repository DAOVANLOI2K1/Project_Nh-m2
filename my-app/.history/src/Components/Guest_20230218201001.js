                ...
                <div className="form_content">
                    ...
                    <div className="common_infor">
                        ...
                        <div className="infor_form-left">
                            ...
                            <input type="Address" className="ms-input form_input" id="GioiTinh" placeholder="Địa chỉ" value={guest.diaChi} />
                        </div>
                        <div className="infor_form-right">
                            <label htmlFor>Họ và tên (<span style={{color: '#ff4747'}}>*</span>)</label>
                            <input type="text" className="ms-input form_input" placeholder="Họ và tên" value={guest.hoTen}/>
