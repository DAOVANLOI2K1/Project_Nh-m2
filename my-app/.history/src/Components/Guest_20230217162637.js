...
class Guest extends Component{
    ...
    getConfigToken(){
        ...
        config = {
            headers: {
                'Authorization': 'Bearer ' + "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6Ikxlc2lhMjAxMiIsInByaW1hcnlncm91cHNpZCI6IlVzZXIgR3JvdXAgMDEiLCJuYmYiOjE2NzY2MjU5NzgsImV4cCI6MTY3NjYyNzc3OCwiaWF0IjoxNjc2NjI1OTc4fQ.MKxkgJyRIvDMQFjWVFKlzupnW4n7MHIgcjkNKOnik_M"
              }
        };
        return config;
    }
        ...
        return(
            <div className="page_right-content">
                <div className="toolbar" id="toolbar">
                    ...
                    {this.handleFormUpdate(this.state.showFormUpdate)}
            </div>
        );
    }
}
