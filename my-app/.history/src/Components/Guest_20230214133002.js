        ...
        return(
                <div className="page_right-content">
                    ...
                    <div className="page_navigate">
                        ...
                        onClick = {(e) => this.initEventPaging(e.target)}>1</li>
                        <li className="pagging_number" value={1}
                        onClick = {(e) => this.initEventPaging(e.target)}>2</li>
                        <li className="pagging_number" value={2}
                        onClick = {(e) => this.initEventPaging(e.target)}>3</li>
                        <li className="pagging_number" value={3}
                        onClick = {(e) => this.initEventPaging(e.target)}>4</li>
                        <li className="pagging_number" value={4}
                        onClick = {(e) => this.initEventPaging(e.target)}>5</li>
                        </ul>
