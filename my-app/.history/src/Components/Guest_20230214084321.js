                ...
                <div className="page_right-content">
                    ...
                    <div className="section2 flex_center" id="show_option">
                        ...
                        <div className="search_option">
                            <input type="text" className="search_input ms-input" option_name="Search" placeholder="Tìm kiếm theo Tên khách hàng" value = "hello" onChange={(e) => console.log(e.target.value)} />
