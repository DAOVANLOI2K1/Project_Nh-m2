    ...
    handleFormUpdate(){
        ...
        if(this.state.showFormUpdate === true && itemActive.length !== 0){
            ...
            let guest = {
                ...
                hoTen: childsItem[0].innerText,
                cmt: childsItem[0].innerText,
                gioiTinh: childsItem[0].innerText,
                sdt: childsItem[0].innerText,
                diaChi: childsItem[0].innerText,
                ghiChu: childsItem[0].innerText,
                ngaySinh: childsItem[0].innerText
            }
            $("#toolbar").hide();
