    ...
    renderbuttonThanhToan(status, cmt) {
        if (status === "Chưa thanh toán") {
            return (<td>
                ...
                <div className="update" commandtype="update" onClick={(e) => {this.turnOnPayment(cmt)}}>
            ...
            </div> <button type="button" className="btn btn-success btn-sm" onClick={() => this.turnOnPayment(cmt)}>Thanh Toán</button></td>);
        }
    }
