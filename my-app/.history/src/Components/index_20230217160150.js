    ...
    render(){
        ...
        <aside id="sidebar" className="sidebar">
          <ul className="sidebar-nav" id="sidebar-nav">
            ...
            <li className="nav-item">
              <a className="nav-link" data-bs-target="#components-nav" data-bs-toggle="collapse" href="#" onClick={(e) => {this.HandleSelectOptions(e.target);
            ...
            <li className="nav-item">
              ...
              onClick={(e) => {this.HandleSelectOptions(e.target);
