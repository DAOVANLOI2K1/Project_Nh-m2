                ...
                <div className="form_content">
                    ...
                    <div className="common_infor">
                        ...
                        <div className="infor_form-right">
                            ...
                            <input type="text" className="ms-input form_input" id="GioiTinh" placeholder="Họ và tên" value={guest.hoTen}/>
                            <label htmlFor>Ngày sinh</label>
                            <input type="date" className="ms-input form_input" placeholder="Ngày sinh" value={guest.ngaySinh}/>
