...
class Admin extends Component{
    ...
    selectDropDownItem(target){
      $("#sidebar-nav").find(".nav-link").addClass("collapsed");
      $(target).closest(".nav-dropdown").toggleClass("collapsed");
    }
    render(){
        return(
            <div>
          ...
          <ul className="sidebar-nav" id="sidebar-nav">
            ...
            <li className="nav-item">
              ...
              <ul id="forms-nav" className="nav-content collapse " data-bs-parent="#sidebar-nav">
                <li>
                  <a className="nav-dropdown" href="#" onClick={(e) => {this.setState({option: "thuê phòng"});
                this.selectDropDownItem(e.target)}}>
                    <i className="bi bi-circle" /><span>Thuê Phòng</span>
                  </a>
                </li>
                <li>
                  <a className="nav-dropdown" href="#" onClick={(e) => {this.setState({option: "gọi dịch vụ"});
                this.selectDropDownItem(e.target)}}>
