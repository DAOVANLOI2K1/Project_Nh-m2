...
class Guest extends Component{
    ...
    componentDidMount = () => {
        ...
        axios.get("https://localhost:5001/api/v1/Guests?pagenumber=1&rowsofpage=50&" + queryString)
        .then((response) => {
            this.setState({
                data: response.data
            })
                ...
                <div className="page_right-content">
                    ...
                    <div className="section2 flex_center" id="show_option">
                        ...
                        <div className="search_option">
                            <input type="text" className="search_input ms-input" option_name="Search" placeholder="Tìm kiếm theo Tên khách hàng" onChange={(e) => {this.setState({search: e.target.value});this.componentDidMount()}} />
