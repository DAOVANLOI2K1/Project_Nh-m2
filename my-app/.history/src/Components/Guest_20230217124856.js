...
class Guest extends Component{
    ...
    getData(url){
        let token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6Ikxlc2lhMjAxMiIsInByaW1hcnlncm91cHNpZCI6IlVzZXIgR3JvdXAgMDEiLCJuYmYiOjE2NzY2MTI1ODMsImV4cCI6MTY3NjYxNDM4MSwiaWF0IjoxNjc2NjEyNTgzfQ.JqHZbkz_-uNwyMuSb6GQPW-7LQGKNlUGD-MvalGcL-M"
        let config = {
            headers: {
