...
class Index extends Component{
    ...
    navToggleEvent(){
      if(this.state.select('.toggle-sidebar-btn')) {
        this.state.on('click', '.toggle-sidebar-btn', function(e) {
          this.state.select('body').classList.toggle('toggle-sidebar')
        })
      }
    }
    render(){
        ...
        <header id="header" className="header fixed-top d-flex align-items-center">
          <div className="d-flex align-items-center justify-content-between">
            ...
            <i className="bi bi-list toggle-sidebar-btn" onClick={this.navToggleEvent()}/>
          </div>{/* End Logo */}
        ...
        <aside id="sidebar" className="sidebar">
          <ul className="sidebar-nav" id="sidebar-nav">
            ...
            <li className="nav-item">
              <a className="nav-link" data-bs-target="#components-nav" data-bs-toggle="collapse" href="index.html">
