...
class Guest extends Component{
    ...
    getConfigToken(){
        ...
        config = {
            headers: {
                'Authorization': 'Bearer ' + "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6Ikxlc2lhMjAxMiIsInByaW1hcnlncm91cHNpZCI6IlVzZXIgR3JvdXAgMDEiLCJuYmYiOjE2NzY2MjQ5NTMsImV4cCI6MTY3NjYyNjc1MywiaWF0IjoxNjc2NjI0OTUzfQ.vxwqQXN7bKCxK-CcTFPJWOzVVTMUB9jcA661CwFo-7Y"
              }
        };
        return config;
    }
