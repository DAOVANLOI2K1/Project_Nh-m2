...
class Guest extends Component{
    ...
    getTotalData(search){
        ...
        axios.get("https://localhost:5001/api/v1/Guests?pagenumber=1&rowsofpage=-1" + stringSearch)
        .then((response) => {
            this.setState({
                total: response.data.le
            });
        });
    }
    ...
    componentDidMount = (url = "https://localhost:5001/api/v1/Guests?pagenumber=1&rowsofpage=50", search = "") => {
        this.getData(url);
    ...
    render(){
        return(
                <div className="page_right-content">
                    ...
                    <span>Hiển thị <span style={{fontWeight: 'bold'}} className="count_datatable">01-{this.state.rowsofpage}/500</span> lao động</span>
