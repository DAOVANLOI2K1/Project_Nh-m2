...
class OrderService extends Component {
    ...
    handleInsert() {
        ...
        if (errorOfCMT || errorOfMaPhong || errorOfMaDV || errorOfThoiGianChon) {
            ...
            let url = "https://localhost:5001/api/v1/OrderServices?CMT=" + this.state.CMT + "&TenPhong=" + this.state.MaPhong + "&DVID=" + this.state.MaDV + "&ThoiGianGoi=" + this.state.ThoiGianGoi;
            this.postData(url);
        }
    }
