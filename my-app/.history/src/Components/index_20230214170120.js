        ...
        <aside id="sidebar" className="sidebar">
          <ul className="sidebar-nav" id="sidebar-nav">
            <li className="nav-item">
              <a className="nav-link collapsed" href="/Quản lý khách sạn" onClick={(e) => this.props.HandleSelectOptions(e.target)}>
                <i className="bi bi-grid" />
                <span>Quản lý khách sạn</span>
              </a>
            </li>{/* End Dashboard Nav */}
            <li className="nav-item">
              <a className="nav-link" data-bs-target="#components-nav" data-bs-toggle="collapse" href="/Quản lý khách hàng" onClick={(e) => {this.props.HandleSelectOptions(e.target);
            ...
            <li className="nav-item">
              <a className="nav-link collapsed" data-bs-target="#forms-nav" data-bs-toggle="collapse" href="/Quản lý giao dịch">
                <i className="bi bi-journal-text" /><span>Quản lý giao dịch</span><i className="bi bi-chevron-down ms-auto" />
              </a>
              <ul id="forms-nav" className="nav-content collapse " data-bs-parent="#sidebar-nav">
                <li>
                  <a href="/Thuê phòng" onClick={() => {this.setState({option: "thuê phòng"})}}>
                    <i className="bi bi-circle" /><span>Thuê Phòng</span>
                  </a>
                </li>
                <li>
                  <a href="/Gọi dịch vụ" onClick={() => {this.setState({option: "gọi dịch vụ"})}}>
            ...
            <li className="nav-item">
              <a className="nav-link collapsed" data-bs-target="#tables-nav" data-bs-toggle="collapse" href="/Quản lý dịch vụ"
              onClick={(e) => {this.props.HandleSelectOptions(e.target);
            ...
            <li className="nav-item">
              <a className="nav-link collapsed" data-bs-target="#charts-nav" data-bs-toggle="collapse" href="/Quản lý phòng"
              onClick={(e) => {this.props.HandleSelectOptions(e.target);
            ...
            <li className="nav-item">
              <a className="nav-link collapsed" data-bs-target="#icons-nav" data-bs-toggle="collapse" href="/Quản lý hóa đơn"
              onClick={(e) => {this.props.HandleSelectOptions(e.target);
