                ...
                <div className="form_content">
                    ...
                    <div className="work_infor">
                        ...
                        <div className="infor_form-left">
                            ...
                            <input type="Text" className="ms-input form_input" id="NgNguoiSua" placeholder="Tên người sửa"/>                             
                        </div>
                        <div className="infor_form-right">
                        <label htmlFor>Ghi chú</label>
                        <textarea type="Text" className="ms-input form_input" placeholder="Điền ghi chú của bạn vào đây!" value={guest.ghiChu}/>
                        </div>
                        </div>
                    </div>
                    </div>
