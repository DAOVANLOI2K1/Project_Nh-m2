        ...
        <aside id="sidebar" className="sidebar">
          <ul className="sidebar-nav" id="sidebar-nav">
            <li className="nav-item">
              <a className="nav-link" href="#" onClick={(e) => {this.selectOptionsEvent(e.target);
            ...
            <li className="nav-item">
              ...
              <ul id="forms-nav" className="nav-content collapse " data-bs-parent="#sidebar-nav">
                <li>
                  <a className="nav-link collapsed nav-dropdown" data-bs-target="#components-nav" data-bs-toggle="collapse" href="#" onClick={(e) => {this.setState({option: "thuê phòng"});
                this.selectOptionsEvent(e.target)}}>
                    <i className="bi bi-circle" /><span>Thuê Phòng</span>
                  </a>
                </li>
                <li>
                  <a className="nav-link collapsed nav-dropdown" data-bs-target="#components-nav" data-bs-toggle="collapse" href="#" onClick={() => {this.setState({option: "gọi dịch vụ"})}}>
            ...
            <li className="nav-item">
              <a className="nav-link collapsed" href="#" onClick={(e) => {this.selectOptionsEvent(e.target);
              this.setState({option: "tài khoản"})}}>
