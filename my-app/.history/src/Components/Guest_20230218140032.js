                ...
                <div className="form_content">
                    ...
                    <div className="common_infor">
                        ...
                        <div className="infor_form-left">
                            ...
                            {this.selectGender(guest.)}
                            <label htmlFor>Số điện thoại (<span style={{color: '#ff4747'}}>*</span>)</label>
                            <input type="number" className="ms-input form_input" placeholder="Số điện thoại" value={guest.sdt} />
                        ...
                        <div className="infor_form-right">
                            ...
                            <input type="date" className="ms-input form_input" placeholder="Ngày sinh" value={this.formatDateInput(guest.ngaySinh)}/>
