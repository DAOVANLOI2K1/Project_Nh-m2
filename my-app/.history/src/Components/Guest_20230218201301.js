...
class Guest extends Component{
    ...
    selectGender(gender){
        if(gender === "Nam"){
            return(
                <select className="select_option" id="GioiTinh">
        ...
        return(
            <div className="container">
                ...
                <div className="form_content">
                    ...
                    <div className="common_infor">
                        ...
                        <div className="infor_form-left">
                            ...
                            <input type="text" className="ms-input form_input" id="MaKH" placeholder="Mã khách hàng" value={guest.maKH} />
                            ...
                            <input type="text" className="ms-input form_input" id="SDT" placeholder="Số điện thoại" value={guest.sdt} />
                            <label htmlFor>Địa chỉ</label>
                            <input type="Address" className="ms-input form_input" id="DiaChi" placeholder="Địa chỉ" value={guest.diaChi} />
                        </div>
                        <div className="infor_form-right">
                            <label htmlFor>Họ và tên (<span style={{color: '#ff4747'}}>*</span>)</label>
                            <input type="text" className="ms-input form_input" id="HoTen" placeholder="Họ và tên" value={guest.hoTen}/>
                            <label htmlFor>Ngày sinh</label>
                            <input type="date" className="ms-input form_input" id="NgaySinh" placeholder="Ngày sinh" value={guest.ngaySinh}/>
                            <label htmlFor>CMT (<span style={{color: '#ff4747'}}>*</span>)</label>
                            <input type="CMT" className="ms-input form_input" id="CMT" placeholder="Chứng minh thư" value={guest.cmt}/>
                        </div>
                        </div>
                    </div>
                    <div className="work_infor">
                        ...
                        <div className="infor_form-left">
                            ...
                            <input type="Text" className="ms-input form_input" id="NguoiSua" placeholder="Tên người sửa"/>                             
                        </div>
                        <div className="infor_form-right">
                        <label htmlFor>Ghi chú</label>
                        <textarea type="Text" className="ms-input form_input" id="GhiChu" placeholder="Điền ghi chú của bạn vào đây!" value={guest.ghiChu}/>
                        </div>
                        </div>
                    </div>
                    </div>
                ...
                <div className="form_footer flex_center">
                    ...
                    <button className="ms-btn ms-btn_icon"><i className="far fa-save icon" onClick={(e) => this.handleUpdate(guest)}/>Lưu</button>
                </div>
                </div>
            </div>
        );
