            ...
            <ul className="d-flex align-items-center">
              ...
              <li className="nav-item dropdown pe-3">
                ...
                <ul className="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                  ...
                  <li>
                    <a className="dropdown-item d-flex align-items-center" href="./" onClick={() => localStorage.removeItem("Token")}>
        ...
        <aside id="sidebar" className="sidebar">
          <ul className="sidebar-nav" id="sidebar-nav">
            <li className="nav-item">
              <a className="nav-link collapsed" href="#" onClick={(e) => this.props.HandleSelectOptions(e.target)}>
                <i className="bi bi-grid" />
                <span>Quản lý khách sạn</span>
              </a>
            </li>{/* End Dashboard Nav */}
            <li className="nav-item">
              <a className="nav-link" data-bs-target="#components-nav" data-bs-toggle="collapse" href="#" onClick={(e) => {this.props.HandleSelectOptions(e.target);
