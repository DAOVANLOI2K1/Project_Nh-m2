                ...
                <div className="form_content">
                    ...
                    <div className="common_infor">
                        ...
                        <div className="infor_form-left">
                            ...
                            <input type="text" className="ms-input form_input" id="GioiTinh" placeholder="Số điện thoại" value={guest.sdt} />
                            <label htmlFor>Địa chỉ</label>
                            <input type="Address" className="ms-input form_input" placeholder="Địa chỉ" value={guest.diaChi} />
                        </div>
