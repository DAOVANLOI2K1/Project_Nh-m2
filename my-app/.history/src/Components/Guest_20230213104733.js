                ...
                <div className="page_right-content">
                    ...
                    <div className="section2 flex_center" id="show_option">
                        ...
                        <div className="search_option">
                            <input type="text" className="search_input ms-input" option_name="Search" placeholder="Tìm kiếm theo Mã, Tên và Số điện thoại" />
                    ...
                    <span>Hiển thị <span style={{fontWeight: 'bold'}} className="count_datatable">01-2/123</span> lao động</span>
                    ...
                    <span className="count_rows count_datatable">2 lao động/trang</span>
                    </div>
                </div>
            </main>
        );
