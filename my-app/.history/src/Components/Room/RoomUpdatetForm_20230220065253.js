    ...
    render(){
        ...
        return(
            ...
            <form>
                ...
                <div className="row mb-3">
                <div>
                    <button type="button" className="btn btn-warning" onClick={() => this.validateRoomForm()}>Sửa</button>
                    <button type="button" className="btn btn-success" onClick={() =>this.props.RoomUpdateCloseForm()}>Quay lại</button>
                </div>
                </div>
            </form>
            </div>
