            ...
            return(
                <tr value={item.khid} onClick={(e) => this.handleSelectRow(e.target)}>
                    ...
                    <div className="flex_center">
                        <div className="delete flex_center" commandtype="delete" onClick={(e) => this.handleDelete(e.target)}>
                            <div className="delete_icon">
                            <i className="fas fa-trash" />
                            </div>
                        </div>
                        <div className="update flex_center" commandtype="update" onClick={(e) => {this.getItemSelected(e.target)this.setState({showFormUpdate: true})}}>
