...
class Guest extends Component{
    ...
    handleUpdate(guest){
        ...
        if(this.validateRequired(guest)){
            return (
                <div>
                    {Swal.fire({
                        title: 'Do you want to save the changes?',
        ...
        return(
            <div className="container">
                ...
                <div className="form_content">
                    ...
                    <div className="work_infor">
                        ...
                        <div className="infor_form-left">
                            ...
                            <input type="Text" className="ms-input form_input" id="modifiedBy" placeholder="Tên người tạo"
                            onChange={(e) => $(e.target).removeClass("required")}/>                          
                        </div>
                        <div className="infor_form-right">
                        <label htmlFor>Ghi chú</label>
                ...
                <div className="form_footer flex_center">
                    ...
                    <button className="ms-btn ms-btn_icon" onClick={(e) => this.handleUpdate()}><i className="far fa-save icon"/>Lưu</button>
                </div>
                </div>
            </div>
        );
