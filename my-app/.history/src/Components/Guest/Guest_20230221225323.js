...
class Guest extends Component{
    ...
    validateFormCreate(guest){
        ...
        let errorOfMaKH = "";
        if (guest.maKH === "") {
            errorOfMaKH = errorOfMaKH + "Mã phòng không được bỏ trống!\n";
        }

        // Thêm validate SĐT
        let errorOfSDT = "";
        if (guest.sdt === "") {
            errorOfSDT = errorOfSDT + "Chưa chọn dịch vụ!\n";
        }

        // Thêm validate Họ Tên
        let errorOfHoTen = "";
        if (guest.hoTen === "") {
            errorOfHoTen = errorOfHoTen + "Chưa chọn được thời gian gọi!\n";
        }
        // Thêm validate Ngày sinh
        let errorOfNgaySinh = "";
        if (guest.ngaySinh === "") {
            errorOfNgaySinh = errorOfNgaySinh + "Chưa chọn được thời gian gọi!\n";
        }
        // Thêm validate Người tạo
        let errorOfModifiedBy = "";
        if (guest.modifiedBy === "") {
            errorOfModifiedBy = errorOfModifiedBy + "Chưa chọn được thời gian gọi!\n";
        }

        // Thêm hiện các dòng validate
        if (errorOfCMT || errorOfMaKH || errorOfHoTen || errorOfSDT || errorOfNgaySinh || errorOfModifiedBy) {
            Swal.fire(
            ...
            document.getElementById("errorOfModifiedBy"
            ).innerHTML = typeof errorOfModifiedBy 
            === "undefined" ? "" : errorOfModifiedBy;
                ...
                <div className="form_content">
                    ...
                    <div className="common_infor">
                        ...
                        <div className="infor_form-left">
                            ...
                            <label style={errorLabel} id="errorOfMaKH"></label>
                            ...
                            {/* Thêm dòng validate số điên thoại */}
                                <label style={errorLabel} id="errorOfSDT"></label>
                            <label htmlFor>Địa chỉ</label>
                        ...
                        <div className="infor_form-right">
                            ...
                            <label style={errorLabel} id="errorOfNgaySinh"></label>
                    ...
                    <div className="work_infor">
                        ...
                        <div className="infor_form-left">
                            ...
                            <input type="Text" className="ms-input form_input" id="createBy" placeholder="Tên người tạo"
                            onChange={(e) => $(e.target).removeClass("required")}/>
                           {/* Thêm dòng validate người tạo */}
                           <label style={errorLabel} id="errorOfModifiedBy"></label>
                        </div>
                        <div className="infor_form-right">
                        <label htmlFor>Ghi chú</label>
