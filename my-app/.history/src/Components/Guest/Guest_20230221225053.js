...
class Guest extends Component{
    ...
    validateFormCreate(guest){
        ...
        if (errorOfCMT || errorOfMaKH || errorOfHoTen || errorOfSDT || errorOfNgaySinh) {
            Swal.fire(
            ...
            document.getElementById("errorOfMaKH").innerHTML = typeof errorOfTenPhong === "undefined" ? "" : errorOfTenPhong;
