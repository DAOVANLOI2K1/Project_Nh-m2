...
class Guest extends Component{
    ...
    validateFormUpdate(guest){
       ...
       if (guest.modifiedBy === "") {
        errorOfModifiedBy = errorOfModifiedBy + "Chứng minh thư không được bỏ trống!\n";
       }
       if (errorOfModifiedBy || errorOfMaKH || errorOfHoTen || errorOfSDT || errorOfNgaySinh || errorOfCreateBy) {
        Swal.fire(
