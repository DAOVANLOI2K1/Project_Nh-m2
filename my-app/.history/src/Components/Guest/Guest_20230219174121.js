                ...
                <div className="form_content">
                    ...
                    <div className="common_infor">
                        ...
                        <div className="infor_form-left">
                            ...
                            <input type="text" className="ms-input form_input" id="sdt" placeholder={guest.sdt}/>
                            <label htmlFor>Địa chỉ</label>
                            <input type="Address" className="ms-input form_input" id="diaChi" placeholder={guest.diaChi}/>
                        </div>
                        <div className="infor_form-right">
                            <label htmlFor>Họ và tên</label>
                            <input type="text" className="ms-input form_input" id="hoTen" placeholder={guest.hoTen}/>
                            <label htmlFor>Ngày sinh</label>
                            <input type="date" className="ms-input form_input" id="ngaySinh" placeholder={guest.ngaySinh}/>
                            <label htmlFor>CMT</label>
                            <input type="CMT" className="ms-input form_input" id="cmt" placeholder={guest.cmt}/>
                        </div>
                        </div>
                    </div>
                    <div className="work_infor">
                        ...
                        <div className="infor_form-left">
                            ...
                            <input type="Text" className="ms-input form_input" id="modifiedBy" placeholder="Tên người sửa" required/>                             
                        </div>
                        <div className="infor_form-right">
                        <label htmlFor>Ghi chú</label>
                        <textarea type="Text" className="ms-input form_input" id="ghiChu" placeholder={guest.ghiChu}/>
                        </div>
                        </div>
                    </div>
                    </div>
