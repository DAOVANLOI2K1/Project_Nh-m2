...
class Guest extends Component{
    ...
    // Format ngày tháng trong input
    formatDateInput = dateSrc => {
        let date = new Date(dateSrc),
            year = date.getFullYear().toString(),
            month = (date.getMonth() + 1).toString().padStart(2, '0'),
            day = date.getDate().toString().padStart(2, '0');
    ...
    renderFormUpdate(guest){
        console.log(this.formatDateInput(guest.ngaySinh));
        return(
                ...
                <div className="form_content">
                    ...
                    <div className="common_infor">
                        ...
                        <div className="infor_form-left">
                            ...
                            <input type="text" className="ms-input form_input" placeholder="Mã nhân viên" value={guest.maKH} />
                        ...
                        <div className="infor_form-right">
                            ...
                            <input type="date" className="ms-input form_input" placeholder="Ngày sinh" value={this.formatDateInput(guest.ngaySinh).toString()}/>
