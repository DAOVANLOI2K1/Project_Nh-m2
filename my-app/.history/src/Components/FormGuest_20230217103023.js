...
class FormGuest extends Component{
    render(){
        return(
            <div className="container form_screen flex_center">
                <div className="form">
                ...
                <div className="form_content">
                    ...
                    <div className="Format_image">
                        <h3 className="Format_image-text">(Vui lòng chọn ảnh có định <br />dạng <br />.jpg .jpeg .png .gif.)</h3>
                    </div>
                    </div>
